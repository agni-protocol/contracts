...
contract AgniPoolDeployer is IAgniPoolDeployer {
    ...
    /// @param factory The contract address of the Agni factory
    ...
    function deploy(
        ...
        pool = address(new AgniPool{salt: keccak256(abi.encode(token0, token1, fee))}());
        delete parameters;
    }
}
