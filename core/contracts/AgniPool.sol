...
import './interfaces/IAgniLmPool.sol';

contract AgniPool is IAgniPool {
    ...
    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IAgniPoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IAgniPoolDerivedState
    ...
    function mint(
        ...
        IAgniMintCallback(msg.sender).agniMintCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IAgniFlashCallback(msg.sender).agniFlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IAgniPoolOwnerActions
