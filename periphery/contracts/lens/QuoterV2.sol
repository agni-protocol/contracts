...
import '@agniswap/core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IAgniSwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IAgniPool) {
        return IAgniPool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IAgniSwapCallback
    function agniSwapCallback(
        ...
        IAgniPool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IAgniPool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
